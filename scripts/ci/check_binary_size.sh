...
#   BINARY_SIZE_HARD_LIMIT_MB (default: 22)
#   BINARY_SIZE_ADVISORY_MB (default: 20)
...
LABEL="${2:-}"
HARD_LIMIT_MB="${BINARY_SIZE_HARD_LIMIT_MB:-22}"
ADVISORY_LIMIT_MB="${BINARY_SIZE_ADVISORY_MB:-20}"
